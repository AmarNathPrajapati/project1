                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight mb-3">New Blog</h1>
                            </div>
                            <!-- Actions -->
                    ...
                    <div class="card shadow border-0 mb-7 p-sm-5">
                        ...
                        <div class="form-box px-sm-5 mb-5">
                            ...
                            onsubmit="return showloader()" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label for="doc_name" class="form-label">Blog Title*</label>
                                ...
                                <!-- <div class="mb-3">
                                    <label for="job_category" class="form-label"> Category</label>
                                ...
                                <div class="mb-3">
                                    <label for="active" class="form-label">Blog Status*</label>
