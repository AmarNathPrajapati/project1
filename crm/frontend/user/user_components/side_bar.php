    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebarCollapse">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="./contact_queries_gec.php">
                    <i class="bi bi-chat-dots"></i> Website Inquiries
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="./product_query_gec.php">
                    <i class="bi bi-chat-dots"></i> Product Related Queries
                    </a>
                </li>
                <!-- <li class="nav-item">
                    <a class="nav-link" href="./home_form_gec.php">
                    <i class="bi bi-chat-dots"></i> Home Queries
                    </a>
                </li> -->
                <!-- <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <i class="bi bi-files"></i> Manage Blogs
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="./manage_machine.php">
                    <i class="bi bi-files"></i>Manage Machines
                    </a>
                </li>
