...
<head>
    ...
    <title>Product Related Queries</title>
</head>
                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight mb-4">Product Related Queries</h1>
                            </div> 
                            <!-- Actions -->
                        ...
                        <div class="table-responsive" style="padding: 30px 18px;">
                            <table class="table table-hover table-nowrap" id="myTable" style="border: 0px solid black !important; padding: 30px 2px;">
                                ...
                                <tbody>
                                    ...
                                    $stmt = "SELECT id,email,product,page_name,created_at FROM products WHERE products.deleted_at IS NULL AND products.archive=(?)order by created_at desc";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td style="font-size: 14px;">
                                                    <?php echo $row["product"] == null ? "Not Available" : $row["product"]; ?>
                                                </td>
