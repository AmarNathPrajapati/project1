                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6 col-12 text-sm-end">
                                <div class="mx-n1">
                                    ...
                                    <a href="./contact_queries_gec.php" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                        <!-- <span class=" pe-2">
                            ...
                            <table class="table table-hover table-nowrap" id="myTable" style="border: 0px solid black !important; padding: 30px 2px;">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th style="font-size: 16px;">Services</th>
                                ...
                                <tbody>
                                    ...
                                    $stmt = "SELECT id,name,email,phone,service,message,page_name,created_at FROM contact_us WHERE contact_us.deleted_at IS NULL AND contact_us.archive=(?)";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td style="font-size: 14px;">
                                                    <?php echo $row["service"]==0?"Not Available":$row["service"]; ?>
                                                </td>
