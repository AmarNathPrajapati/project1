<?php
    ...
    if(!empty($_POST['email']) && !empty($_POST['name']) && isset($_POST['phone']) && !empty($_POST['service']) && !empty($_POST['message']))
    {
        ...
        $stmt="INSERT INTO `contact_us` (email,phone,name,service,message,page_name) VALUES (?,?,?,?,?,?)";
        $sql = mysqli_prepare($conn, $stmt);
        mysqli_stmt_bind_param($sql, 'sissss', $email, $phone, $name, $service,$message,$flag);
